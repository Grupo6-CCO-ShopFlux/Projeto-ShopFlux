    ...
    arduino.pipe(new serialport.ReadlineParser({ delimiter: '\r\n' })).on('data', async (data) => {
        ...
        if (HABILITAR_OPERACAO_INSERIR) {
            ...
            if (AMBIENTE == 'producao') {
                ...
                sqlquery = `INSERT INTO medida (dht11_umidade, dht11_temperatura, luminosidade, lm35_temperatura, chave, momento, fkGrafico) VALUES (${dht11Umidade}, ${dht11Temperatura}, ${luminosidade}, ${lm35Temperatura}, ${chave}, CURRENT_TIMESTAMP, 1)`;

                // CREDENCIAIS DO BANCO REMOTO - SQL SERVER
                const connStr = "Server=grupo6-1cco.database.windows.net;Database=shopflux;User Id=grupo06-1cco;Password=#Shopflux;";
                ...
                await poolBancoDados.execute(
                    'INSERT INTO medida (dht11_umidade, dht11_temperatura, luminosidade, lm35_temperatura, chave, momento, fkGrafico) VALUES (?, ?, ?, ?, ?, now(), 1)',
